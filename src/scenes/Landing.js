      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveMediumScreens ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-150 hover:rounded-3xl transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px] rounded-t-full shadow-lg shadow-indigo-500/50"
